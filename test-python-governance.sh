...
# ==================================================
# GOVERNANCE POC - PYTHON REFERENCE DEMO SCRIPT
# ==================================================
#
# PURPOSE:
# Demonstrates how governance configurations control pipeline behavior
# by reading governance/ngpos-python-reference/*.properties files
#
...
GOVERNANCE_DIR="governance/ngpos-python-reference"

echo ""
echo "════════════════════════════════════════════════════════════"
echo "   NGPOS PIPELINE GOVERNANCE POC - PYTHON REFERENCE DEMO"
echo "════════════════════════════════════════════════════════════"
echo ""
...
check_and_run \
    ...
    "Running pytest tests with coverage analysis"
...
check_and_run \
    ...
    "Running behavior-driven acceptance tests (Behave)"
...
echo "   • Changes require @HarshitaY-KR approval via CODEOWNERS"
echo ""
