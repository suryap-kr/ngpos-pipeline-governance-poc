...
# ==================================================
# GOVERNANCE POC - GO REFERENCE DEMO SCRIPT
# ==================================================
#
# PURPOSE:
# Demonstrates how governance configurations control pipeline behavior
# by reading governance/ngpos-go-reference/*.properties files
#
...
GOVERNANCE_DIR="governance/ngpos-go-reference"

echo ""
echo "════════════════════════════════════════════════════════════"
echo "   NGPOS PIPELINE GOVERNANCE POC - GO REFERENCE DEMO"
echo "════════════════════════════════════════════════════════════"
echo ""
...
check_and_run \
    ...
    "Running Go tests with coverage analysis"
...
check_and_run \
    ...
    "Running behavior-driven acceptance tests (Godog)"
